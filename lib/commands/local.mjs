...
const HELP = `drawcms local [<type>] <spec.json | name> [--out <file>] [--editor <url>] [--seed] [--static] [--json]
...
engine and produces a document you load into that editor.
  ...
  --static        Strip engine-derived motion (default: animated, story kept).
...
export async function run({ flags, positional }) {
  ...
  const built = buildDocument(spec, { static: flags.static === true });
